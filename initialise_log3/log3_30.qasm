...
u(0,2.191981133989078,-2.1919811339890782) q[21];
u(0,2.191981133989078,-2.1919811339890782) q[23];
u(0,2.191981133989078,-2.1919811339890782) q[25];
cx q[9],q[11];
u(0,0,-pi/4) q[11];
cx q[12],q[11];
u(0,0,pi/4) q[11];
...
cx q[22],q[24];
u(0,0,-pi/4) q[24];
u(0,2.191981133989078,-2.1919811339890782) q[26];
cx q[27],q[24];
u(0,0,pi/4) q[24];
cx q[22],q[24];
u(pi/2,pi/4,-pi) q[22];
cx q[20],q[22];
u(0,0,-pi/4) q[22];
u(0,2.191981133989078,-2.1919811339890782) q[24];
cx q[25],q[22];
u(0,0,pi/4) q[22];
cx q[20],q[22];
u(pi/2,pi/4,-pi) q[20];
cx q[18],q[20];
u(0,0,-pi/4) q[20];
u(0,2.191981133989078,-2.1919811339890782) q[22];
cx q[23],q[20];
u(0,0,pi/4) q[20];
cx q[18],q[20];
u(pi/2,pi/4,-pi) q[18];
